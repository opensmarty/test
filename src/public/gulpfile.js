/*
 ...
 npm install --save-dev gulp-if gulp- gulp-rev-replace gulp-clean gulp-order gulp-webserver
 npm install --save-dev gulp-add-src vinyl-paths run-sequence vinyl-source-stream vinyl-buffer del
 npm install --save-dev gulp-jshint browserify　browser-sync　gulp-shell　gulp-ssh
